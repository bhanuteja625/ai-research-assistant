...
class Researcher:
    ...
    def __init__(self, serper_api_key=None, weaviate_api_key=None):
        if serper_api_key and weaviate_api_key:
        ...
        self.client = weaviate.Client(
            url="https://cluster1-k4fnxthe.weaviate.network",
    ...
    def from_dict(cls, d):
        researcher = cls(
            serper_api_key=d['serper_api_key'],
            weaviate_api_key=d['weaviate_api_key'],
        )
        return researcher
